...
export const metadata = {
  title: 'CMS Page Not Found - Ridgewood Insights',
  description: 'The cms page you are looking for does not exist.',
};
  ...
  return (
    <div className="flex min-h-[calc(100vh-200px)] flex-col items-center justify-center bg-background px-4 py-16">
      <div className="max-w-md text-center">
        ...
        {/* Heading */}
        <h2 className="mb-2 text-2xl font-bold text-secondary">CMS page not found</h2>

        {/* Description */}
        <p className="mb-8 text-text">
          The cms page you&apos;re looking for doesn&apos;t exist or you may not have access to it.
        </p>
