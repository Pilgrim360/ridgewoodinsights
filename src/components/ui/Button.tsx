...
const variantClasses: Record<ButtonVariant, string> = {
    ...
    outline:
        'bg-white text-primary border-2 border-primary hover:bg-primary hover:text-white active:bg-[#004347] disabled:border-surface disabled:text-surface disabled:opacity-60 transition-all duration-200',
    ghost:
