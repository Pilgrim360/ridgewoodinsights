...
import { MediaItem } from '@/lib/cms/media';
import { formatFileSize, formatDate } from '@/lib/cms/dates';
...
import { useDeleteMedia } from '@/hooks/queries/useCmsMutations';
...
export function MediaBrowser({
  ...
  const handleDelete = async (path: string) => {
    ...
    try {
      ...
      // errors are handled by the global cms toast system
    }
  };
