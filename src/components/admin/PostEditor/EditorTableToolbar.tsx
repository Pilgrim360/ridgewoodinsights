  ...
  return (
    <>
      <ToolbarButton
        ...
        isActive={inTable && editor.isActive('table', { align: 'left' })}
        onClick={() => editor.chain().focus().toggleTableAlignment('left').run()}
      >
      ...
      <ToolbarButton
        ...
        disabled={disabled || !inTable}
        isActive={inTable && editor.isActive('table', { align: 'center' })}
        onClick={() => editor.chain().focus().setTableAlignment('center').run()}
      >
      ...
      <ToolbarButton
        ...
        disabled={disabled || !inTable}
        isActive={inTable && editor.isActive('table', { align: 'right' })}
        onClick={() => editor.chain().focus().toggleTableAlignment('right').run()}
      >
